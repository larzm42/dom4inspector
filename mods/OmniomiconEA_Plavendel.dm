...
#description "Project Omniomicon (Chapter 2 - Plavendel BETA 1) by Pymous (http://www.pymous.com)" 
#version 0.11 -- 28/12/2014
...
#defunit1 4415 -- Diseased Soldier (basic units in forts. Without fort only if PD>20)  
#defunit1b 4416 -- Diseased Archer (idem, deuxieme type) 
#defunit2 4408 -- Blue Soldier (bonus uniquement pour forts PD>20)
#defunit2b 4409 -- Blue Archer (idem)
#defcom1 4423 -- Diseased commander (defaut commander)
#defcom2 4411 -- Blue Priest (extra commander PD>20)
...
--#addreccom 4444 -- ATTENTION TEST A SUPPRIMER PAR LA SUITE 
--#addreccom 4445 -- ATTENTION TEST A SUPPRIMER PAR LA SUITE 
--#addreccom 4446 -- ATTENTION TEST A SUPPRIMER PAR LA SUITE 
--#addreccom 4447 -- ATTENTION TEST A SUPPRIMER PAR LA SUITE 
--#addreccom 4448 -- ATTENTION TEST A SUPPRIMER PAR LA SUITE 
--#addreccom 4449 -- ATTENTION TEST A SUPPRIMER PAR LA SUITE 
--#addreccom 4450 -- ATTENTION TEST A SUPPRIMER PAR LA SUITE 
--#addreccom 4451 -- ATTENTION TEST A SUPPRIMER PAR LA SUITE 
...
--#addrecunit 4427 -- ATTENTION TEST A SUPPRIMER PAR LA SUITE : Blue Fire Elemental
...
--HEROES--
--#hero1 4261 -- Hero 1 - The Blue Archmage
--#hero2 4262 -- Hero 2 - The Blue Troll
--#hero3 4263 -- Hero 3 - The first Blue
--#hero4 4264 -- Hero 4 - Alloy master
--#hero5 4265 -- Hero 5 - The burnig Blue
--#hero6 4266 -- Hero 6 -
--#multihero1 4415 -- IL FAUDRA FAIRE DU MULTIHERO de BLUE SOLDIERS plus puissants?

--SPECIAL RECRUITMENTS --
#addforeigncom 4422 -- Fanatic commander

#addforeignunit 4420 -- Fanatic Spearman
#addforeignunit 4429 -- Fanatic Swordman
#addforeignunit 4419 -- Fanatic Archer
#addforeignunit 4421 -- Fanatic Cav
#end
...
--#newsite 1773 -- Removed , Set #reqtemple to all fanatics
--#name "Blue Cult Circle" -- peut etre creer des fanatique un peu speciaux? en armure?
--#path 4 -- 
--#rarity 5
--#homecom 4422 -- Fanatic commander

--#homemon 4420 -- Fanatic Spearman
--#homemon 4429 -- Fanatic Swordman
--#homemon 4419 -- Fanatic Archer
--#homemon 4421 -- Fanatic Cav
--#end
...
#path 4 -- 
#rarity 5
--#com 4422 -- Fanatic commander

--#mon 4420 -- Fanatic Spearman
--#mon 4429 -- Fanatic Swordman
--#mon 4419 -- Fanatic Archer
--#mon 4421 -- Fanatic Cav
#end
...
#name "Ultimage" --- 
#descr "The Ultimage is a Plavendel creature of such great power and knowledge that he has mastered his own mortality. Donning a godly mantle, he has taken the role of a Pretender God. The Ultimage is a master of magical research and adept in several of the known magic paths."
...
#ap 10 
#eyes 2
#weapon 7 -- Quarterstaff (change to other thing in future)
#armor 158 -- Robes
#goodleader 
#goodmagicleader
#goodundeadleader
...
#name "Blistarad" --- 
#descr "Plavendels considers death as an opportunity and the start of a new, true life, because they will be judged by the eye of Radyacin, the Clestial Artifact. Many think that Plavendels have no concepts of fear or death. In reality Plavendels have their own ideas of them of it and they fear one thing, the Blistarad. The Blistarad is the white flame, the finger of Radyacin that can melt corpses as ice melts under the sun.
...
#name "Blue Master"
#descr "They are the most powerfull Blues. Highly skilled mages, few in numbers, they seem to be the voice and will of the Celestial Artifact and command all others Blues."
...
#custommagic 7296 50 -- S/D/F/E
#custommagic 32640 50 -- ALL
...
#name "Blue Renovator"
#descr "Before resurection rituals, each corpses are brought to Blue Renovators. Their role is to repair them when required, thanks to their forbidden and immoral
 necromancy magic knowledge, to simply allow or ensure optimal resurection."
...
#name "Shining Blue"
#descr "They spend most of their time close to the Celestial Artifact or inside Temples were holy Shining Spheres are present. 
At theses sacred places, they enchent sacred items made from the Plavendel Alloy like the glowing spheres themsleves or weapons that were forged by Blue Smithes. They are also responsible for resurection rituals after the corpses were prepared by the Corpses Preparators. 
Due to the time they spend in such close contact with Blue sources, their skin has taken an even  darker blue color. Their presence is a divine inspiration.
 
NOTE: This unit can erect Shining Spheres in Provinces where temples, labs and forts were built. When stationned in such provinces or in the Capital, Shining Blues process to resurections rituals."
...
#name "Blue Smith"
#descr "Blue Smiths are Plavendel crafters. They are in charge to forge holy items, weapons and spheres made from an unusual alloy. 
This material of unknown composition has a very low hardness and poor mechanical properties compared to iron, copper or even gold.
In fact this material was designed by the Plavendel for a unique purpose: this is the only known material that can absorb and reemit the Holy glowing light from the Celestial Artifact.
While Blue Smiths excel at forging all theses holy items and those linked to Astral, Earth, Death and Fire magic, they are not used to any other form of crafting 

(IMPORTANT NOTE: #magicboost -5 to others magic paths)"
...
#name "Blue Warleader"
#descr "Famous warriors and leaders before their resurection, They are the supreme Plavendel warleaders of Blue and mundane 
armies. Their awe is so high that local population enroll themselves as militia under the Plavendel banner."
...
Fanatic leaders are religious figures before being fighters and when no waging war, they often spend their time spreading the word to recruit new fanatics (summon allies)"
...
#descr "Plavendel religion and power is growing, and some young mages have freely choose to join this cult and follow now the teaching and ways of the Blues. To prepare their future true life after reincarnation, they  assist the Blue Priest in their tasks and are responsible for any research experiments and documentation. The Blues don't have time for it."
...
#gcost 10010
#rcost 1
#custommagic 7296 100 -- 128 + 1024 + 2048 + 4096 Fire/Air/Astral/death
...
#descr "The Sacred Alloy is essential to Plavendel society. Young mages specially trained and initiated to Earth prospection are sent to identify and collect all the special ingredients required to create this mysterious Alloy. All the raw materials are then brought to Blue Smiths."
...
#name "Corpse Seeker"
#descr "Young Acolytes skilled in necromancy are assigned to a special and noble task in Plavendel society: their role is to scour the lands in order to find fresh corpses from people who died from the Blue disease. Thanks to their death skills and knowledge, they can keep corpses fresh enough and bring them back to Corpse Preparators in the Capital for reincarnation."
...
#descr "The most fanatics Acolytes are sent to spread the good words about the Faith and Blue reincarnation outside Plavendel. They aims to
 collect donations to the Cult and sign contracts with richs and powerfull people to garantee their future resurection."
...
#descr "It is said theses stranges immaterial creatures are small Blistarad avatars, sent to clear Radyacin Eye from threatening impurities."
...
#name "Summon Blue Fire Elementals"
#descr "Description missing"
...
#2d6units -4402 -- 2d6 de Blue resurected
...
#hiddensite 1772 -- Add a new hidden site in the province
#revealsite -- reveal site in province
#incdom 3 -- la creation de la sphere entrain +3 dominion local
#gemloss 4 -- perd 2d6 de astral pearls
#end

--- SUPPRESION DE GLOBE LORSQUE PROVINCE CONQUISE-- NON POSSIBLE POUR L'INSTANT
-------
...
#2d6units -4403 -- 2d6 de Undeads Bleus
#end
