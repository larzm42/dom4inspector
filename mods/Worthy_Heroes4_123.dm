...
------------------------------------------------------------------------------
------------------------------------------------------------------------------
-- THIS MOD FILE HAS BEEN MODIFIED BY GLOBU AS FOLLOWS:

[*] Golden Woman's incorrect sprite filename fixed.
[*] Cursed Blade's secondaryeffect Leg Chop -> secondaryeffectalways, since it
    is AoE.
[*] Experiment's pincer (235) attack replaced with pincer (273) so that it is
    not lost when the unit's human arms are holding different weapons. (Pincer
    273 has the bonus flag, while pincer 235 doesn't.)
[*] Golden Naga is now size 5 and amphibian.
[*] Auluudh given taskmaster, given that all other mindlords have it.
